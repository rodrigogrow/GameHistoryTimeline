...
(function(){
	...
	content = {
        ...
        'video_gameplay': [
            {'url': 'Gameplay: https://www.youtube.com/watch?v=181bEWh0KqI', 'caption': "Gameplay do Jogo", 'type': "youtube"} // type: youtube or vimeo
        ],
        'demos': [
        ...
        'references': [
            ...
            {'url': 'http://www.arkade.com.br/street-fighter-completa-24-anos-relembre-primeiro-game-serie/
', 'caption': "STREET FIGHTER COMPLETA 24 ANOS! RELEMBRE O PRIMEIRO GAME DA SÉRIE!"},
            ...
            {'url': 'http://www.techtudo.com.br/noticias/noticia/2012/03/especial-a-historia-da-serie-street-fighter-parte-1.html
', 'caption': "Especial: a história da série Street Fighter – Parte 1"}
        ]
}
	{
        'type': 'game', // game or console
        ...
        'images': [
         ...
         'video_gameplay': [
            {'url': 'https://www.youtube.com/watch?v=ia8bhFoqkVE', 'caption': "Super Mario Bros. - NES Gameplay", 'type': "youtube"} // type: youtube or vimeo
        ],
        'demos': [
